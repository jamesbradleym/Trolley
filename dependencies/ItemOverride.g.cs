...
{
	/// <summary>
	/// Override metadata for ItemOverride
	/// </summary>
	public partial class ItemOverride : IOverride
	{
	...
	public static class ItemOverrideExtensions
    {
		/// <summary>
        /// Apply Item edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Item Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<ItemOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, ItemIdentity, bool> identityMatch,
            Func<T, ItemOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Item Overrides to apply — typically `input.Overrides.Item`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<ItemOverride> overrideData,
            Func<T, ItemIdentity, bool> identityMatch,
            Func<T, ItemOverride, T> modifyElement
            ) where T : Element
        {
        ...
        /// </summary>
        /// <param name="edits">The collection of edit overrides (Overrides.Item)</param>
        /// <param name="additions">The collection of add overrides (Overrides.Additions.Item)</param>
        /// <param name="removals">The collection of remove overrides (Overrides.Removals.Item)</param>        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        ...
        public static List<T> CreateElements<T>(
            this IList<ItemOverride> edits,
            IList<ItemOverrideAddition> additions,
            IList<ItemOverrideRemoval> removals,            Func<ItemOverrideAddition, T> createElement,
            Func<T, ItemIdentity, bool> identityMatch,
            Func<T, ItemOverride, T> modifyElement,
