...
namespace Trolley
{
    public class Function
    {
        ...
        private UrlModelStore<TrolleyInputs> store;

        public async Task<TrolleyOutputs> Handler(TrolleyInputs args)
        {
            ...
            if(this.store == null)
            {
                this.store = new UrlModelStore<TrolleyInputs>();
            }
            

            var l = new InvocationWrapper<TrolleyInputs,TrolleyOutputs> (store, Trolley.Execute);
